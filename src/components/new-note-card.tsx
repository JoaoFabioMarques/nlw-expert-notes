...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger
        className="rounded-md text-left flex flex-col bg-slate-700 p-5 gap-3 overflow-hidden relative outline-none
        ...
        <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              ...
              >
                <span className="text-slate-900 hover:underline">
                  Salvar Nota
                </span>
              </button>
            )}
